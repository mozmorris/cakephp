 ...
 **/
	function testCleanInsert() {
		$result = CakeString::cleanInsert(':incomplete', array('clean' => true, 'before' => ':', 'after' => ''));
		...
		$result = CakeString::cleanInsert(':in.complete', array('clean' => true, 'before' => ':', 'after' => ''));
		$this->assertEqual($result, '');

		$result = CakeString::cleanInsert(':in.complete and', array('clean' => true, 'before' => ':', 'after' => ''));
		$this->assertEqual($result, '');

		$result = CakeString::cleanInsert(':in.complete or stuff', array('clean' => true, 'before' => ':', 'after' => ''));
		$this->assertEqual($result, 'stuff');

		$result = CakeString::cleanInsert('<p class=":missing" id=":missing">Text here</p>', array('clean' => 'html', 'before' => ':', 'after' => ''));
